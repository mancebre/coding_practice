/**
 ...
 URL: "https://www.codewars.com/kata/5302d655be2a91068b0001fb/train/javascript"
 */
...
DI.prototype.inject = function(func) {
  // TODO try top get arguments.
  console.log(func.toString());

  let dependency = this.dependency;

  return function() {
    return func(dependency.dep3, dependency.dep1, dependency.dep2);
  };
};
