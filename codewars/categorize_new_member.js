...
for a single potential member. Information consists of an integer for the person's age and an 
...
PATH:https://www.codewars.com/kata/5502c9e7b3216ec63c0001aa/
*/

function openOrSenior(data){
    let result = [];
    for(let i in data) {
        result.push(data[i][0] >= 55 && data[i][1] > 7 ? 'Senior' : 'Open');
    }
